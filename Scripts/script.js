$(function () {
    ...
    $('.product .item').on({
        mouseover: function () {
            $(this).find('.btn-buy').append($('.please-click'));
        },
        click: function () {
            $(this).find('.btn-buy').append($('.please-click'));
        },
    ...
    $("#messageCustomer").css("font-size", "20px");
    $(".bntSendCustomerContact").click(function (e) {
        ...
        if (CustomerName == "") {
            $(".CustomerName").focus();
            $(".CustomerName").addClass("text-danger bg-warning");
            $("#messageCustomer").show();
            $("#messageCustomer").html("Bạn chưa nhập tên!");
            e.preventDefault();
            return;
        }
        if (CustomerPhoneNumber == "") {
            $(".CustomerPhoneNumber").focus();
            $(".CustomerPhoneNumber").addClass("text-danger bg-warning");
            $("#messageCustomer").show();
            $("#messageCustomer").html("Bạn chưa nhập số điện thoại!");
            e.preventDefault();
            return;
        }
    });
